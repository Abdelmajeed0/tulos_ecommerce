...
// Variable: PRODUCT_BY_SLUG_QUIERY
// Query: *[_type == 'product' && slug.current == $slug] | order(name asc) [0]
export type PRODUCT_BY_SLUG_QUIERYResult = {
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: CATEGORIES_QUIERY
// Query: *[_type == 'category'] | order(name asc)
export type CATEGORIES_QUIERYResult = Array<{
  _id: string;
  _type: "category";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type == 'product' && slug.current == $slug] | order(name asc) [0]": PRODUCT_BY_SLUG_QUIERYResult;
    "*[_type == 'category'] | order(name asc)": CATEGORIES_QUIERYResult;
  }
}
